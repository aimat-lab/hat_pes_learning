...
indir_data_true = 'nequip/my_data/dft_IDs' # 'nequip/my_data/dft_IDs' 

indir_data_pred = 'allegro_eval/{}'.format(eval_name)
...
# test
path_data_test_pred = '{}/hat_test/{}_test.xyz'.format(indir_data_pred, datasetname) # a: 
...
# eval
path_data_eval_pred = '{}/hat_eval/{}_eval.xyz'.format(indir_data_pred, datasetname)
...
# lin ID10
path_data_lin_test_pred = '{}/hat_lin_train/{}_lin_train.xyz'.format(indir_data_pred, datasetname) #test
...
# lin eval
path_data_lin_eval_pred = '{}/hat_lin_eval/{}_lin_eval.xyz'.format(indir_data_pred, datasetname)
